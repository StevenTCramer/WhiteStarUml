...
uses
  ...
  ContributorMgr,
  MainFrm, InspectorFrm, ColEdtFrm, AboutFrm, MessageFrame,
  ...
  ShellAPI, ComServ, NLS, SaveDialogEx, XMLDom,
  // for test
  ExtDlgs, JVStrings;
...
begin
  with MainForm do begin
    ...
    OnInformationMessagesButtonClicked := MainFormInformationMessagesButtonClickedHandler;
