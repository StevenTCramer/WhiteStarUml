...
begin
  ...
  if ElementName = 'UMLProject' then
  begin
  ...
  else if ElementName = 'UMLModel' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
  end
  else if ElementName = 'UMLSubsystem' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
  ...
  else if ElementName = 'UMLPackage' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
  end
  else if ElementName = 'UMLClass' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
  ...
  else if ElementName = 'UMLInterface' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineAttributesProperty;
  ...
  else if ElementName = 'UMLEnumeration' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
  ...
  else if ElementName = 'UMLSignal' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineAttributesProperty;
  ...
  else if ElementName = 'UMLException' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineAttributesProperty;
  ...
  else if ElementName = 'UMLComponent' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineAttributesProperty;
  ...
  else if ElementName = 'UMLComponentInstance' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfInstance;
  end
  else if ElementName = 'UMLNode' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineAttributesProperty;
  ...
  else if ElementName = 'UMLNodeInstance' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfInstance;
  end
  else if ElementName = 'UMLUseCase' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineAttributesProperty;
  ...
  else if ElementName = 'UMLActor' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineAttributesProperty;
  ...
  else if ElementName = 'UMLActivityGraph' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLStateMachine' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLCompositeState' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfState;
    SpecifyPropertiesOfCompositeState;
  end
  else if ElementName = 'UMLCollaboration' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineTemplateParametersProperty;
  end
  else if ElementName = 'UMLCollaborationInstanceSet' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLInteraction' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLInteractionInstanceSet' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLActionState' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfState;
    SpecifyPropertiesOfActionState;
  end
  else if ElementName = 'UMLSubactivityState' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfState;
    SpecifyPropertiesOfCompositeState;
  ...
  else if ElementName = 'UMLPseudostate' then
  begin
    SpecifyPropertiesOfModelElement;
    DefinePseudostateKindProperty;
  end
  else if ElementName = 'UMLFinalState' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfState;
  end
  else if ElementName = 'UMLPartition' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLSubmachineState' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfState;
    SpecifyPropertiesOfCompositeState;
  ...
  else if ElementName = 'UMLAttribute' then
  begin
    SpecifyPropertiesOfModelElement;
  ...
  else if ElementName = 'UMLOperation' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineScopeKindProperty('OwnerScope', 'Detail', 'OwnerScope', False);
  ...
  else if ElementName = 'UMLParameter' then
  begin
    SpecifyPropertiesOfModelElement;
    P := APropertySpecifier.DefineProperty('Type', 'General', 'Type', rkTextButtonRow);
    P.IsUnique := True;
  ...
  else if ElementName = 'UMLTemplateParameter' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
  ...
  else if ElementName = 'UMLEnumerationLiteral' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLTransition' then
  begin
    SpecifyPropertiesOfModelElement;
  ...
  else if ElementName = 'UMLCallAction' then
  begin
    SpecifyPropertiesOfModelElement;
  ...
  else if ElementName = 'UMLSendAction' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfAction;
  ...
  else if ElementName = 'UMLCreateAction' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfAction;
  ...
  else if ElementName = 'UMLDestroyAction' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfAction;
  end
  else if ElementName = 'UMLReturnAction' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfAction;
  end
  else if ElementName = 'UMLUninterpretedAction' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfAction;
  end
  else if ElementName = 'UMLSignalEvent' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLCallEvent' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLTimeEvent' then
  begin
    SpecifyPropertiesOfModelElement;
    P := APropertySpecifier.DefineProperty('When', 'Detail', 'When', rkTextRow);
    P.ImageIndex := GENERAL_ROW_IMAGEINDEX;
  end
  else if ElementName = 'UMLChangeEvent' then
  begin
    SpecifyPropertiesOfModelElement;
    P := APropertySpecifier.DefineProperty('ChangeExpression', 'Detail', 'ChangeExpression', rkTextRow);
    P.ImageIndex := GENERAL_ROW_IMAGEINDEX;
  end
  else if ElementName = 'UMLClassifierRole' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineMultiplicityProperty('Multiplicity', 'Detail', 'Multiplicity', False);
  ...
  else if ElementName = 'UMLObject' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfInstance;
  end
  else if ElementName = 'UMLObjectFlowState' then
  begin
    SpecifyPropertiesOfModelElement;
    P := APropertySpecifier.DefineProperty('Type', 'General', 'Type', rkTextButtonRow);
    P.RowEditable := False;
  ...
  else if ElementName = 'UMLFlowFinalState' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfState;
  end
  else if ElementName = 'UMLSignalAcceptState' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfState;
    SpecifyPropertiesOfActionState;
  end
  else if ElementName = 'UMLSignalSendState' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfState;
    SpecifyPropertiesOfActionState;
  end
  else if ElementName = 'UMLArtifact' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfGeneralizableElement;
    DefineAttributesProperty;
  ...
  else if ElementName = 'UMLAttributeLink' then
  begin
    SpecifyPropertiesOfModelElement;
  ...
  else if ElementName = 'UMLPort' then
  begin
    SpecifyPropertiesOfModelElement;
    P := APropertySpecifier.DefineProperty('Type', 'General', 'Type', rkTextButtonRow);
    P.IsUnique := True;
  ...
  else if ElementName = 'UMLDependency' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfDependency;
  end
  else if ElementName = 'UMLAssociation' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfAssociation;
  end
  else if ElementName = 'UMLAssociationClass' then
  begin
    // None.
  end
  else if ElementName = 'UMLGeneralization' then
  begin
    SpecifyPropertiesOfModelElement;
  ...
  else if ElementName = 'UMLLink' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfLink;
  end
  else if ElementName = 'UMLAssociationRole' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfAssociation;
    DefineMultiplicityProperty('Multiplicity', 'Detail', 'Multiplicity', False);
  end
  else if ElementName = 'UMLStimulus' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfMessage;
  end
  else if ElementName = 'UMLMessage' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfMessage;
  end
  else if ElementName = 'UMLInclude' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLExtend' then
  begin
    SpecifyPropertiesOfModelElement;
    P := APropertySpecifier.DefineProperty('Condition', 'General', 'Condition', rkTextRow);
    P.ImageIndex := GENERAL_ROW_IMAGEINDEX;
  end
  else if ElementName = 'UMLRealization' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfDependency;
  end
  else if ElementName = 'UMLConnector' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfConnector;
  end
  else if ElementName = 'UMLAssociationEnd' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfAssociationEnd;
  end
  else if ElementName = 'UMLAssociationEndRole' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfAssociationEnd;
    DefineMultiplicityProperty('CollaborationMultiplicity', 'Detail', 'CollaborationMultiplicity', False);
  end
  else if ElementName = 'UMLLinkEnd' then
  begin
    SpecifyPropertiesOfModelElement;
  end
  else if ElementName = 'UMLConnectorEnd' then
  begin
    SpecifyPropertiesOfModelElement;
    SpecifyPropertiesOfConnectorEnd;
  end
  else if ElementName = 'UMLClassDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
    DefineDefaultDiagramProperty;
  end
  else if ElementName = 'UMLUseCaseDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
    DefineDefaultDiagramProperty;
  end
  else if ElementName = 'UMLComponentDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
    DefineDefaultDiagramProperty;
  end
  else if ElementName = 'UMLDeploymentDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
    DefineDefaultDiagramProperty;
  end
  else if ElementName = 'UMLSequenceDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
  ...
  else if ElementName = 'UMLCollaborationDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
    SpecifyPropertiesOfInteractionDiagram;
  end
  else if ElementName = 'UMLSequenceRoleDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
    SpecifyPropertiesOfInteractionDiagram;
  ...
  else if ElementName = 'UMLCollaborationRoleDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
    SpecifyPropertiesOfInteractionDiagram;
  end
  else if ElementName = 'UMLActivityDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
  end
  else if ElementName = 'UMLStatechartDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
  end
  else if ElementName = 'UMLCompositeStructureDiagram' then
  begin
    DefineNameProperty('Name', 'General', 'Name');
    SpecifyPropertiesOfDiagram;
    DefineDefaultDiagramProperty;
...
begin
  ...
  else if Key = 'Visibility' then
  begin
    Result := VisibilityToPropertyValue(AElement.MOF_GetAttribute(Key));
  end
  else if Key = 'Stereotype' then
  begin
    Result := (AElement as PUMLModelElement).StereotypeName;
  end
  else if Key = 'IsSpecification' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'IsAbstract' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'IsRoot' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'IsLeaf' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  ...
  else if Key = 'Operations' then
  begin
    Result := GetCollectionStr(AElement, 'Operations');
  end
  else if Key = 'TemplateParameters' then
  begin
  ...
  else if Key = 'IsMultiInstance' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'DeployedComponents' then
  begin
    Result := GetCollectionStr(AElement, 'DeployedComponents');
  end
  else if Key = 'DeployedArtifacts' then
  begin
    Result := GetCollectionStr(AElement, 'DeployedArtifacts');
  end
  else if Key = 'IsInstantiable' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'EntryActions' then
  begin
    Result := GetCollectionStr(AElement, 'EntryActions');
  end
  else if Key = 'DoActions' then
  begin
    Result := GetCollectionStr(AElement, 'DoActivities');
  end
  else if Key = 'ExitActions' then
  begin
    Result := GetCollectionStr(AElement, 'ExitActions');
  end
  else if Key = 'IsDynamic' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'DynamicArguments' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'DynamicMultiplicity' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'IsConcurrent' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'PseudostateKind' then
  begin
  ...
  begin
    Result := '';
    if AElement is PUMLStructuralFeature then
    begin
    ...
    else if AElement is PUMLParameter then
    begin
    ...
    else if AElement is PUMLObjectFlowState then
    begin
  ...
  else if Key = 'IsNavigable' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'Aggregation' then
  begin
    Result := AggregationKindToPropertyValue(AElement.MOF_GetAttribute(Key));
  end
  else if Key = 'Qualifiers' then
  begin
    Result := GetCollectionStr(AElement, 'Qualifiers');
  end
  else if Key = 'CollaborationMultiplicity' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'OwnerScope' then
  begin
    Result := ScopeKindToPropertyValue(AElement.MOF_GetAttribute(Key));
  end
  else if Key = 'Parameters' then
  begin
    Result := GetCollectionStr(AElement, 'Parameters');
  end
  else if Key = 'Specification' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'Concurrency' then
  begin
    Result := CallConcurrencyKindToPropertyValue(AElement.MOF_GetAttribute(Key));
  end
  else if Key = 'IsQuery' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'DefaultValue' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'DirectionKind' then
  begin
    Result := ParameterDirectionKindToPropertyValue(AElement.MOF_GetAttribute(Key));
  end
  else if Key = 'GuardCondition' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'Effects' then
  begin
    Result := GetCollectionStr(AElement, 'Effects');
  end
  else if Key = 'Triggers' then
  begin
  ...
  else if Key = 'IsAsynchronous' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'Script' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'When' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'ChangeExpression' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'Client' then
  begin
  ...
  else if Key = 'Discriminator' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'End1.Name' then
  begin
  ...
  else if Key = 'End1.Visibility' then
  begin
    if AElement is PUMLAssociation then
  ...
  else if Key = 'End1.Participant' then
  begin
  ...
  else if Key = 'End2.Visibility' then
  begin
    if AElement is PUMLAssociation then
  ...
  else if Key = 'End2.Participant' then
  begin
  ...
  else if Key = 'Condition' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'Mapping' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  ...
  else if Key = 'RaisedSignals' then
  begin
    Result := GetCollectionStr(AElement, 'RaisedSignals');
  end
  else if Key = 'ActionKind' then
  begin
    Result := '';
  ...
  else if Key = 'ParameterType' then
  begin
    Result := AElement.MOF_GetAttribute('ParameterType');
  end
  else if Key = 'SubMachine' then
  begin
    Result := '';
    if AElement is PUMLSubMachineState then
    begin
    ...
    else if AElement is PUMLSubactivityState then
    begin
  ...
  else if Key = 'Instantiation' then
  begin
  ...
  else if Key = 'ShowSequenceNumber' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'MessageSignature' then
  begin
    Result := MessageSignatureToPropertyValue(AElement.MOF_GetAttribute(Key));
  end
  else if Key = 'ShowActivation' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'DefaultDiagram' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'Arguments' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  ...
  else if Key = 'Iteration' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'Branch' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'DiagramType' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'Slots' then
  begin
  ...
  else if Key = 'IsService' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'IsBehavior' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  ...
  else if Key = 'IsOrdered' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'IsUnique' then
  begin
    Result := AElement.MOF_GetAttribute(Key);
  end
  else if Key = 'End1.Role' then
  begin
  ...
  else if Key = 'RepresentedElement' then
  begin
...
procedure PUMLPropertyAdaptor.PropertyButtonClicked(AElementSet: POrderedSet; Key: string);
  ...
  begin
    Result := nil;
    if (CallAction.Message <> nil) then
    begin
      // ASSERTIONS
    ...
    else if (CallAction.Stimulus <> nil) then
    begin
      // ASSERTIONS
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if Elem is PUMLObjectFlowState then
        begin
        ...
        begin
          ...
          if ElementSelectorForm.Execute(TXT_ELEMSELTTL_TYPE, True) then
          begin
    ...
    begin
      ...
      begin
        ...
        ElementSelectorForm.ClearSelectableModels;
        ElementSelectorForm.AddSelectableModels(CLASSIFIER_FILTERINGSET);
        if ElementSelectorForm.Execute(TXT_ELEMSELTTL_INSTANTIATION) then
        begin
    ...
    begin
      ...
      begin
        ...
        if AElementSet.Items[0] is PUMLCallAction then
        begin
          ...
          if ElementListForm.Execute(TXT_ELEMLSTTTL_OPERATION) then
          begin
    ...
    begin
      ...
      begin
        ...
        ElementListForm.AllowNull := True;
        if ElementListForm.Execute(TXT_ELEMLSTTTL_SIGNAL) then
        begin
    ...
    begin
      ...
      begin
        ...
        ElementListForm.AllowNull := True;
        if ElementListForm.Execute(TXT_ELEMLSTTTL_SUBMACHINE) then
        begin
    ...
    begin
      ...
      begin
        ...
        ElementSelectorForm.ClearSelectableModels;
        ElementSelectorForm.AddSelectableModels(CLASSIFIER_FILTERINGSET);
        if ElementSelectorForm.Execute(TXT_ELEMSELTTL_BASE) then
        begin
    ...
    begin
      if StereotypeSelectorForm.Execute(AElementSet) then
      begin
    ...
    begin
      ...
      begin
        ...
        if AElementSet.Items[0] is PUMLAttributeLink then
        begin
          ElementListForm.ClearListElements;
          ...
          if ElementListForm.Execute(TXT_ELEMLSTTTL_VALUE) then
          begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if ElementListForm.Execute(TXT_ELEMLSTTTL_ATTRIBUTE) then
          begin
