...
begin
  ...
  AssociationGroup.Visible := ivNever;
  VisibilityGroup.Visible := ivAlways;
...
begin
  ...
  VisibilityGroup.Visible := ivNever;
  AssociationGroup.Visible := ivAlways;
